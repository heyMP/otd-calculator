	...
	<div class="calculator-card">
		<header class="calculator-header">
			<div class="title">
				<svg
					...
					><path
						d="M19.5 2H4.5C3.39543 2 2.5 2.89543 2.5 4V20C2.5 21.1046 3.39543 22 4.5 22H19.5C20.6046 22 21.5 21.1046 21.5 20V4C21.5 2.89543 20.6046 2 19.5 2Z"
						stroke="#059669"
						stroke-width="2"
		...
		<div class="calculator-body">
			<div class="left-column">
				...
				>
					...
					<div class="input-container">
						...
						<input
							...
							bind:value={otdPrice}
							placeholder="35,000"
							readonly={mode === "selling"}
						/>
					</div>
					<p class="description">
						This is the final amount you want to write the check for.
					</p>
				</section>
				...
				>
					<label for="vehiclePrice"> Vehicle Selling Price </label>
					<div class="input-container">
						<span class="adornment">$</span>
						<input
							id="vehiclePrice"
							...
							placeholder="31,916.82"
							readonly={mode === "out the door"}
						/>
					</div>
					<p class="description">
						This is the negotiated price of the car before any fees or taxes.
					</p>
				</section>
					...
					<div class="custom-fees-list">
						...
						{#each customFees as fee, i}
							<div class="custom-fee-item">
								...
								<button
									on:click={() => removeCustomFee(i)}
									class="remove-fee-btn">&times;</button
								>
							</div>
						{/each}
					</div>
